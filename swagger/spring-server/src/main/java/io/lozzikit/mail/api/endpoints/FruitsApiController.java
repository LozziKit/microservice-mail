package io.lozzikit.mail.api.endpoints;

import io.lozzikit.mail.api.FruitsApi;
import io.lozzikit.mail.entities.FruitEntity;
import io.lozzikit.mail.api.model.Fruit;
import io.lozzikit.mail.repositories.FruitRepository;
...
public class FruitsApiController implements FruitsApi {
    ...
    public ResponseEntity<List<Fruit>> getFruits() {
        ...
        List<Fruit> mail = new ArrayList<>();
        mail.add(staticFruit);
        */
